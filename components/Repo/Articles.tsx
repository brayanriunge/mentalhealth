                    ...
                    <motion.div
                     initial="hidden"
                       ...
                       variants={{
                        ...
                        >
                        <p className="my-5 ">
                        Discover your mental health journey with our comprehensive assessment quiz. 
                        This user-friendly tool delves into various aspects of mental well-being, 
                        providing valuable insights and personalized recommendations. Answer 
                        thoughtfully and gain a deeper understanding of your emotional landscape. 
                        </p>
                        <p className="mb-5">
                        Empower yourself today with our assessment quiz, designed to be a supportive 
                        starting point on your path to mental well-being. Take the first step towards 
