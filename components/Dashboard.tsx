             ...
             >
               ...
               > 
                ...
                <p className="mt-8 text-lg font-bold text-justify">
                 ...
                 and vital step towards a brighter tomorrow. Whether you're seeking support, information, 
                 or simply a place to be heard, you've come to the right place.
                 Feel free to explore the resources, articles, and services we offer. 
                 Remember, your well-being is our priority, and we're honored to be a part of your journey.
                </p>
            </motion.div>
            {/** Actions */}
            <motion.div 
